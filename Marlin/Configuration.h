...
#define STRING_CONFIG_H_AUTHOR "(Miklos Gal, default config)" // Original author or contributor.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_SMARTPRINTCOREH7X
#endif
...
#define XY_AFTER_HOMING { 140, 140 }  // (mm) Move to an XY position after homing (and raising Z)
...
#define Z_SAFE_HOMING
  ...
  //#define Z_SAFE_HOMING_X_POINT 180  // (mm) X point for Z homing
  //#define Z_SAFE_HOMING_Y_POINT 280  // (mm) Y point for Z homing
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL3_TYPE  NEO_GRB
  #define NEOPIXEL2_PIN              PE12
  #define NEOPIXEL3_PIN              PB5
  #define NEOPIXEL_PIN               PB9 // PA15
